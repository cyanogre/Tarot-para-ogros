// Versión corregida de la función Netlify
exports.handler = async function(event) {
    ...
    if (API_KEY && API_KEY.length > 10) {
        ...
        console.error("[FUNCIÓN v2]: ¡ERROR! La variable API_KEY existe pero es muy corta.");
    } else {
        console.error("[FUNCIÓN v2]: ¡ERROR GRAVE! La variable process.env.API_KEY no está configurada.");
        return { 
            statusCode: 500, 
    ...
    // --- CORRECCIÓN AQUÍ: Se cambió el nombre del modelo a uno existente ---
